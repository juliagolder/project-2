...
def printRoll(dice):
    ...
    if ask1 == 'yes' or ask1 == 'y':
        cha1 = input('what would you like to change it to?')
        L[0]=cha1
        print(L)
    ask2 = input('roll die 2 again?')
    if ask2 == 'yes' or ask2 == 'y':
        cha2 = input('what would you like to change it to?')
        L[1]=cha2
        print(L)
    ask3 = input('roll die 3 again?')
    if ask3 == 'yes' or ask3 == 'y':
        cha3 = input('what would you like to change it to?')
        L[2]=cha3
        print(L)
    ask4 = input('roll die 4 again?')
    if ask4 == 'yes' or ask4 == 'y':
        cha4 = input('what would you like to change it to?')
        L[3]=cha4
        print(L)
